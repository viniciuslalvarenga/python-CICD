"""
Arquivo de configuracao do pytest para testes.
...
# proj_tests.fixtures.project_dir funciona com import path para resolver imports
pytest_plugins = ["proj_tests.fixtures.project_dir"]
